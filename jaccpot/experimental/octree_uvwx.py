"""Uniform-octree colleague / U / V interaction-list construction (2B step 4, O(N) FMM).

Foundation for a fully-parallel O(N) adaptive FMM (see benchmark_a100/RESUME.md). The
