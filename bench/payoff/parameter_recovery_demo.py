...
explicitly out of scope for Paper I; the `jaccpot/applications/potential_recovery/`
package it was written against has been deleted rather than retargeted. Nothing
here runs until that case is picked up in a later paper.
