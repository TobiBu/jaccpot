...
**F33 substantially closed 2026-08-27** — `fmm_autotune.py` 92%, `fmm_strict_cap_profile.py` 94%, `fmm_strict_run.py` 79%, all on CPU. The row waited on a GPU it never needed; see the note under D.3.
